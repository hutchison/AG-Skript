...
\begin{proof}
    ...
    \begin{figure}[ht]
        \input{tikz/Hilbert-Satz-s1c.tikz}
    \end{figure}
...
\begin{figure}[ht]
    \input{tikz/Hilbert-ModellendlichaffineGeometrie.tikz}
\end{figure}
        ...
        \item["`$\Longrightarrow$"'] Wir betrachten die $x$-Achse $g$. Nach
            ...
            \begin{description}
                ...
                % siehe Hartshorne, Proposition 15.3
                    ...
                    \begin{figure}[ht]
                        \input{tikz/Hilbert-Streckenaddition.tikz}
                    \end{figure}
                ...
                \item[Multiplikation] Parallele durch $B = (0,b)$ zur Geraden durch die beiden
                    ...
                    \begin{figure}[ht]
                        \input{tikz/Hilbert-Streckenmultiplikation.tikz}
                    \end{figure}
...
Ein weiteres Modell, das den Inzidenz- und Anordnungsaxiomen genügt, ist das Poincarésche
...
\begin{figure}[ht]
    \input{tikz/Hilbert-Kreisscheibenmodell.tikz}
...
\begin{figure}[ht]
    \input{tikz/Hilbert-InversionamKreis.tikz}
