...
\begin{figure}[ht]
    \input{tikz/KonstruktionLot.tikz}
...
\begin{figure}[ht]
    \input{tikz/KonstruktionParalleleeinerGeraden.tikz}
...
\begin{figure}[ht]
    \input{tikz/Parallelenaxiom.tikz}
...
\begin{figure}[ht]
    \begin{tabular}{cc}
        \input{tikz/NebenwinkelanParallelen.tikz}
        &
        \input{tikz/InnenwinkelsummeDreieck.tikz}
    \end{tabular}
...
\begin{figure}[ht]
    \input{tikz/TeilungStreckeinnTeile.tikz}
...
\begin{figure}[ht]
    \input{tikz/ProduktvonLaengen.tikz}
...
\begin{figure}[ht]
    \input{tikz/DiagonalevomQuadrat.tikz}
...
\begin{proof}
    ...
    \begin{figure}[ht]
        \input{tikz/SatzdesPythagoras.tikz}
...
\begin{figure}[ht]
    \input{tikz/KonstruktionQuadratwurzel.tikz}
...
\begin{figure}[ht]
    \input{tikz/KonstruktionRechtwinkligesDreieck.tikz}
...
\begin{proof}
    ...
    \begin{figure}[ht]
        \input{tikz/Peripheriewinkelsatz.tikz}
...
\begin{figure}[ht]
    \input{tikz/FlaecheninhaltRechteck.tikz}
...
\begin{figure}[ht]
    \input{tikz/FlaecheninhaltDreieck.tikz}
...
\begin{figure}[ht]
    \input{tikz/FlaecheninhaltParallelogrammUmformung.tikz}
...
\begin{figure}[ht]
    \input{tikz/SatzdesPythagorasProportionalitaetsprinzip.tikz}
...
\begin{proof}[Beweis des Strahlensatzes \ref{thm:strahlensatz}]
    ...
    \begin{figure}[ht]
        \input{tikz/BeweisStrahlensatz.tikz}
