...
\begin{figure}[h]
    \input{tikz/Desargues/Costrizione-Legittima1.tikz}
...
\begin{figure}[h]
    \input{tikz/Desargues/Costrizione-Legittima2.tikz}
...
\subsection*{Axiomatisierung}
  ...
  \begin{description}
      \item[Modell 1] Endliche projektive Ebene \\
          ...
          \begin{figure}[h]
            \begin{tabular}{cc}
              \input{tikz/Desargues/Modell1-EndlicheProjektiveEbene.tikz}
              &
              \input{tikz/Desargues/Modell1-FanoEbene.tikz}
            \end{tabular}
...
\subsection*{Rechnen mit homogenen Koordinaten}
  ...
  \begin{figure}[h]
    \input{tikz/Desargues/homogene-Koordinaten--Verbindungsgerade.tikz}
  ...
  \begin{figure}[h]
    \input{tikz/Desargues/homogene-Koordinaten--Schnittpunkt-zweier-Gerade.tikz}
...
\subsection*{projektive Automorphismen}
  ...
  \begin{thm}[Theorem von Pappos\footnote{Pappos von Alexandria, ca. $300$ n. Chr., griechischer Mathematiker}] \ \\
    ...
    \begin{figure}[h]
      \input{tikz/Desargues/projektive-Automorphismen--Theorem-von-Pappos.tikz}
  ...
  \begin{thm}[Theorem von Desargues] \label{Theorem-von-Desargues}\ \\
    ...
    \begin{figure}[h]
      \input{tikz/Desargues/projektive-Automorphismen--Theorem-von-Desargues.tikz}
  ...
  \begin{thm}[Scheren-Satz] \ \\
    ...
    \begin{figure}[h]
      \input{tikz/Desargues/projektive-Automorphismen--Scheren-Satz.tikz}
...
\subsection*{Projektive Arithmetik}
    ...
    \begin{description}
        \item[Addition] Bevor wir die Addition begründen können, benötigen wir ein Grundgerüst. Dieses besteht aus $3$ Geraden, 
              ...
              \begin{figure}[h]
                \input{tikz/Desargues/projektive-Arithmetik--Gerade-unendlich-ferner-Punkte.tikz}
              ...
              \begin{figure}[h]
                \input{tikz/Desargues/projektive-Arithmetik--Addition.tikz}
        ...
        \item[Multiplikation] Für die projektive Multiplikation benötigen wir ein ähnliches Grundgerüst. Wir wählen wieder die $x$- und 
              ...
              \begin{figure}[h]
                \input{tikz/Desargues/projektive-Arithmetik--Multiplikation.tikz}
...
\subsection*{Zentral- und Parallelprojektion}
  ...
  \begin{figure}[h]
    \input{tikz/Desargues/Zentralprojektion-und-Parallelprojektion--Zentralprojektion.tikz}
  ...
  \begin{figure}[h]
    \input{tikz/Desargues/Zentralprojektion-und-Parallelprojektion--Parallelprojektion.tikz}
  ...
  \begin{figure}[h]
    \input{tikz/Desargues/Zentralprojektion-und-Parallelprojektion--1-dimensionaler-projektiver-Raum.tikz}
...
\subsection*{Doppelverhältnis}
  ...
  \begin{figure}[h]
    \input{tikz/Desargues/Doppelverhaeltnis--obere-Halbebene.tikz}
